...
let vehicles: string[] = ["convertible car" , "Raft" , "Speed Boat" , "Ferrari F8 Tributo"]
vehicles.map((items) => console.log(`“I would like to own a ${items}”`));


// 2ND WAY
// Define an array of favorite modes of transportation
const favoriteTransportation: string[] = ["Tesla Model S", "Honda CB650R motorcycle", "Vespa scooter", "Toyota Prius", "Boeing 747"];
